...
| funds | Theft | hire night security, and a cloud based backup of all data including camera footage. ensure the safe has an auto lock to lock securely behind when closed | 1 |
| funds | Supply chain disruption | partner with known trusted venders, and plan to have a hedge in products. partner with sister branches to share resources. | 1 |
